...
export const products: Product[] = [
  {
    ...
    description: 'Well-maintained laptop with 16GB RAM and 512GB SSD. Includes charger and protective sleeve.',
    price: 850,
    status: 'active',
    categoryId: '1',
  ...
  },
  {
    ...
    description: 'Adjustable chair with lumbar support and breathable mesh back. Gently used.',
    price: 120,
    status: 'active',
    categoryId: '3',
  ...
  },
  {
    ...
    description: 'Set of three calculus books with minimal annotations. Great for first-year courses.',
    price: 65,
    status: 'sold',
    categoryId: '2',
  ...
  },
  {
    ...
    description: 'Classic turntable with built-in speakers. Includes a starter vinyl collection.',
    price: 140,
    status: 'active',
    categoryId: '7',
  ...
  },
  {
    ...
    description: 'Compact fridge with freezer compartment. Clean and energy efficient.',
    price: 75,
    status: 'reserved',
    categoryId: '6',
  ...
  },
  {
    id: 'p6',
    title: 'Winter Coat',
    description: 'Warm insulated coat, size M. Worn a few times, no damage.',
    price: 55,
    status: 'active',
    categoryId: '4',
    ...
    dormitoryName: 'Berkeley College',
  ...
  },
  {
    ...
    description: 'Lightweight helmet with adjustable fit. Includes spare padding.',
    price: 35,
    status: 'sold',
    categoryId: '5',
    categoryName: 'Sports',
  ...
  },
  {
    ...
    description: 'Portable speaker with 10-hour battery. Great sound quality.',
    price: 40,
    status: 'active',
    categoryId: '1',
    categoryName: 'Electronics',
